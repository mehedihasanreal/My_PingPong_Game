...
# Window
wind = turtle.Screen()
wind.title('PingPong game by Mehedi')
wind.bgcolor('black')
...
sboard.hideturtle()
sboard.goto(0, 260)
sboard.write("Player 1: 0   Player 2: 0 ", align="center", font=("Courier", 24, 'normal'))
...
while True:
    ...
    if ball.xcor() > 350:
        score_a += 1
        sboard.clear()
        sboard.write("Player 1: {}   Player 2: {}".format(score_a, score_b), align='center',
